 ...
 */
final class Version20240509182740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE denominacion (idDo INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, calificada TINYINT(1) DEFAULT 0 NOT NULL, creacion INT DEFAULT NULL, web VARCHAR(50) DEFAULT NULL, imagen VARCHAR(50) NOT NULL, historia LONGTEXT NOT NULL, descripcion LONGTEXT NOT NULL, descripcionVinos LONGTEXT NOT NULL, url VARCHAR(50) NOT NULL, idRegion INT NOT NULL, INDEX IDX_D860CE2A6C7359EC (idRegion), PRIMARY KEY(idDo)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
