 ...
 */
final class Version20240512214936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bodega (idBodega INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, direccion VARCHAR(50) NOT NULL, poblacion VARCHAR(25) DEFAULT NULL, provincia VARCHAR(25) NOT NULL, codPostal VARCHAR(5) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, telefono VARCHAR(16) DEFAULT NULL, web VARCHAR(50) DEFAULT NULL, url VARCHAR(50) NOT NULL, idDo INT NOT NULL, INDEX IDX_5CD2A5F61ACF2A1 (idDo), PRIMARY KEY(idBodega)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE denominacion (idDo INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, calificada TINYINT(1) DEFAULT 0 NOT NULL, creacion INT DEFAULT NULL, web VARCHAR(50) DEFAULT NULL, imagen VARCHAR(50) NOT NULL, imagen_historia VARCHAR(50) NOT NULL, imagen_uva VARCHAR(50) NOT NULL, logo VARCHAR(50) NOT NULL, historia LONGTEXT NOT NULL, descripcion LONGTEXT NOT NULL, descripcionVinos LONGTEXT NOT NULL, url VARCHAR(50) NOT NULL, idRegion INT NOT NULL, INDEX IDX_D860CE2A6C7359EC (idRegion), PRIMARY KEY(idDo)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE espumoso (idEspumoso INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(25) NOT NULL, descripcion LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_49612C413A909126 (nombre), PRIMARY KEY(idEspumoso)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vino (idVino INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(40) NOT NULL, descripcion LONGTEXT NOT NULL, notaCata LONGTEXT NOT NULL, imagen VARCHAR(50) NOT NULL, url VARCHAR(50) NOT NULL, idColor INT NOT NULL, idAzucar INT DEFAULT NULL, idEspumoso INT DEFAULT NULL, idMaduracion INT DEFAULT NULL, idBodega INT NOT NULL, idSabor INT DEFAULT NULL, idCuerpo INT DEFAULT NULL, idBoca INT DEFAULT NULL, INDEX IDX_E65EA1371920BF4 (idColor), INDEX IDX_E65EA1376844289 (idAzucar), INDEX IDX_E65EA131AC2061A (idEspumoso), INDEX IDX_E65EA1320CC5C34 (idMaduracion), INDEX IDX_E65EA1366DC82C5 (idBodega), INDEX IDX_E65EA13FB33C64F (idSabor), INDEX IDX_E65EA13C43EA542 (idCuerpo), INDEX IDX_E65EA13F4785BBD (idBoca), PRIMARY KEY(idVino)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE vino ADD CONSTRAINT FK_E65EA131AC2061A FOREIGN KEY (idEspumoso) REFERENCES espumoso (idEspumoso)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vino DROP FOREIGN KEY FK_E65EA131AC2061A');
        ...
        $this->addSql('DROP TABLE espumoso');
